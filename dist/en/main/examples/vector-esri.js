import { Cr as fromLonLat, Dn as createXYZ, Fn as Stroke, Ln as Fill, Mn as Map, Pn as Style, an as ImageTileSource, bn as VectorLayer, dn as VectorSource, jn as TileLayer, m as EsriJSON, or as View, vn as tile } from "./common.js";
//#region examples/vector-esri.js
var fillColors = {
	"Lost To Sea Since 1965": [
		0,
		0,
		0,
		1
...
var vector = new VectorLayer({
	source: new VectorSource({
		...
		url: function(extent, resolution, projection) {
			...
			return "https://services-eu1.arcgis.com/NPIbx47lsIiu2pqz/ArcGIS/rest/services/Neptune_Coastline_Campaign_Open_Data_Land_Use_2014/FeatureServer/0/query/?f=json&returnGeometry=true&spatialRel=esriSpatialRelIntersects&geometry=" + encodeURIComponent("{\"xmin\":" + extent[0] + ",\"ymin\":" + extent[1] + ",\"xmax\":" + extent[2] + ",\"ymax\":" + extent[3] + ",\"spatialReference\":{\"wkid\":" + srid + "}}") + "&geometryType=esriGeometryEnvelope&inSR=" + srid + "&outFields=*&outSR=" + srid;
		},
	...
	style: function(feature) {
		const color = fillColors[feature.get("LU_2014")] || [
			0,
			0,
			0,
			0
