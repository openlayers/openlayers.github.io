 ...
 */
export function generatePointRenderInstructions(batch: import("./MixedGeometryBatch.js").PointGeometryBatch, renderInstructions: Float32Array, labels: import("../../webgl/LabelsArray.js").default, customAttributes: import("./VectorStyleRenderer.js").AttributeDefinitions, transform: import("../../transform.js").Transform): Float32Array;
/**
 * Render instructions for lines are structured like so:
 ...
 * @return {Float32Array} Generated render instructions
 */
export function generateLineStringRenderInstructions(batch: import("./MixedGeometryBatch.js").LineStringGeometryBatch, renderInstructions: Float32Array, labels: import("../../webgl/LabelsArray.js").default, customAttributes: import("./VectorStyleRenderer.js").AttributeDefinitions, transform: import("../../transform.js").Transform): Float32Array;
/**
 ...
 * @return {Float32Array} Generated render instructions
 */
export function generatePolygonRenderInstructions(batch: import("./MixedGeometryBatch.js").PolygonGeometryBatch, renderInstructions: Float32Array, labels: import("../../webgl/LabelsArray.js").default, customAttributes: import("./VectorStyleRenderer.js").AttributeDefinitions, transform: import("../../transform.js").Transform): Float32Array;
