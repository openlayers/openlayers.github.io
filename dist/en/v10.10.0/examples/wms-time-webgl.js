import { Ct as TileWMS, Gr as getCenter, Ht as WebGLTileLayer, Mn as Map, kr as transformExtent, or as View, yn as StadiaMaps } from "./common.js";
//#region examples/wms-time-webgl.js
...
var stadiaLayer = new WebGLTileLayer({ source: new StadiaMaps({ layer: "stamen_terrain" }) });
var tileWmsLayer = new WebGLTileLayer({
	extent,
	source: new TileWMS({
...
//# sourceMappingURL=wms-time-webgl.js.map